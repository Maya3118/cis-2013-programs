...
if (boolPrinting === true)
{
    if (boolRedLight === true)
    {
        ...
        {
            stringOutput = stringMessage2 + stringMessage3 + stringMessage4;//code
        }//code
        else {
        ...
        if (boolRecognised === true)
        {
            stringOutput = stringMessage1 + stringMessage2 + stringMessage3;//code
        }
        else {
    ...
    if (boolRedLight === true)
    {
        if (boolRecognised === true)
        {
            stringOutput = stringMessgae3 + stringMessage4;//code
        }
        else {
        ...
        if (boolRecognised === true)
        {
            stringOutput = stringMessage3;//code
        }
        else {
